    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="grid mask">
                    <figure>
                        <img class="img-responsive" src="images/portfolio/folio01.jpg" alt=""><!--在href处书写查询到的第一张图片的地址代码-->
                        <figcaption>
                            <h5>DASHBOARD</h5><!--在此书写查询到的第一个作品标题代码-->
                            <a href="#" class="btn btn-primary btn-lg">查看</a><!-- 在href处书写查询到的第一个作品地址代码 -->
                        </figcaption>
                    </figure>
                </div>
            </div>
            ...
            <div class="col-md-5 pull-right">   <!-- 使用Bootstrap的「pull-right」类靠右对齐 -->
                <div class="grid mask">
                    <figure>
                        <img class="img-responsive" src="images/portfolio/folio02.jpg" alt=""><!--在href处书写查询到的第二张图片的地址代码-->
                        <figcaption>
                            <h5>UI DESIGN</h5><!--在此书写查询到的第二个作品标题代码-->
...
<div class="container" id="contact" name="contact">
    <div class="row">
        ...
        <div class="col-lg-4">
            <h3>联系我们</h3>
            <p><span class="icon icon-home"></span> 广东省广州市XX区XX街道X号<br/>
